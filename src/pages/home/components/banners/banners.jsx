            ...
            >
                {isLoading ? (
                    <>
                        {[...Array(3)]?.map((_, i) => (
                            <SwiperSlide key={i}>
                                <div role="status" className="flex items-center justify-center h-[500px] max-w-full bg-gray-300 rounded-lg gap-20 animate-pulse dark:bg-gray-500">

                                    {/* <div>
                                    <div role="status" className="max-w-full animate-pulse">
                                        <div className="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-4" />
                                        <div className="h-4 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[460px] w-full mb-2.5" />
                                    ...
                                    <svg className="w-[100px] h-full text-gray-200 dark:text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
